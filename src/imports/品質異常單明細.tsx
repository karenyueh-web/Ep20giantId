import svgPaths from "./svg-4yzx75cjns";
  ...
  return (
    <div className="absolute inset-[0.17%_0_3.69%_0]" data-name="stack">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.0001 34.6104">
        <g id="stack">
          <path clipRule="evenodd" d={svgPaths.p394a5c00} fill="url(#paint0_linear_72_12434)" fillRule="evenodd" id="vector" />
          <path clipRule="evenodd" d={svgPaths.p24400500} fill="url(#paint1_linear_72_12434)" fillRule="evenodd" id="vector_2" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_72_12434" x1="12.2341" x2="36.0001" y1="10.8444" y2="34.6104">
            <stop stopColor="#77ED8B" />
            <stop offset="1" stopColor="#22C55E" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_72_12434" x1="0" x2="28.9534" y1="0.00021312" y2="28.9537">
    ...
    <div className="relative shrink-0 size-[20px]" data-name="icons/solid/ic-eva:attach-2-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="icons/solid/ic-eva:attach-2-fill">
          <path d={svgPaths.p11611100} fill="var(--fill-0, #637381)" id="primary-shape" />
        </g>
      </svg>
    </div>
  );
...
function Stack1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-h-px min-w-px relative" data-name="stack">
      ...
      <p className="css-ew64yg font-['Public_Sans:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#637381] text-[12px]">{`QA-1361 辐条牙端金属件出现倒角和无倒角两种.pdf `}</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents left-[32px] top-[1099px]">
      <div className="absolute bg-white border border-[#1c252e] border-solid h-[105px] left-[32px] rounded-[8px] top-[1099px] w-[1013px]" />
      <p className="absolute css-4hzbpn font-['Public_Sans:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold h-[26px] leading-[24px] left-[40px] text-[14px] text-black top-[1099px] w-[61px]">確認回覆</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex h-[52px] items-start left-[45px] p-[10px] top-[1116px] w-[473px]">
      <p className="css-ew64yg font-['Public_Sans:Light','Noto_Sans_JP:Light',sans-serif] font-light leading-[24px] relative shrink-0 text-[#1c252e] text-[12px]">後續會要求廠商圖面修改尺寸，確認來貨車把手尺寸符合圖面要求</p>
    </div>
  );
}
...
function Stack6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-start left-[32px] overflow-clip top-[1214px] w-[1009px]" data-name="stack">
      <p className="css-4hzbpn font-['Public_Sans:SemiBold','Noto_Sans_JP:Bold',sans-serif] font-semibold h-[29px] leading-[22px] relative shrink-0 text-[#1c252e] text-[14px] w-full">附件</p>
      <Upload1 />
    </div>
  );
