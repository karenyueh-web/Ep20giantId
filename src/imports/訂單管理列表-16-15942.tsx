import svgPaths from "./svg-041zh9e41j";
    ...
    <div className="relative shrink-0 w-full" data-name="Tabs">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[40px] items-center px-[20px] py-0 relative w-full">
          ...
          <Tab4 />
          <Tab5 />
          <div className="absolute bg-[rgba(145,158,171,0.08)] bottom-0 h-[2px] left-0 right-[592px]" data-name="divider" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="start icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_16_16064)" id="start icon">
          <path d={svgPaths.p1217be00} fill="var(--fill-0, #1C252E)" id="primary-shape" />
        </g>
        <defs>
          <clipPath id="clip0_16_16064">
...
function StartIcon1() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="start icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_16_16067)" id="start icon">
          <path d={svgPaths.p3eb7fd80} fill="var(--fill-0, #1C252E)" id="primary-shape" />
        </g>
        <defs>
          <clipPath id="clip0_16_16067">
            <rect fill="white" height="18" width="18" />
          </clipPath>
        </defs>
      </svg>
...
function StartIcon2() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="start icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_16_16040)" id="start icon">
          <path d={svgPaths.p2d84de50} fill="var(--fill-0, #1C252E)" id="primary-shape" />
        </g>
        <defs>
          <clipPath id="clip0_16_16040">
            <rect fill="white" height="18" width="18" />
          </clipPath>
        </defs>
      </svg>
...
function StartIcon4() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="start icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_16_16061)" id="start icon">
          <g id="primary-shape">
            <path d={svgPaths.p3ed0db00} fill="var(--fill-0, #FF5630)" />
            <path clipRule="evenodd" d={svgPaths.p93aca00} fill="var(--fill-0, #FF5630)" fillRule="evenodd" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_16_16061">
