...
import svgPaths from "./svg-d3sqyijlo6";
type Wrapper12Props = {
                      ...
                      <div className="relative shrink-0 size-[36px]" data-name="icons/notifications/ic-chat">
                        <div className="absolute inset-[0.17%_0_3.69%_0]" data-name="stack">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 23.0734">
                            <g id="stack">
                              <path clipRule="evenodd" d={svgPaths.p3a4a2480} fill="url(#paint0_linear_4332_6967)" fillRule="evenodd" id="vector" />
                              <path clipRule="evenodd" d={svgPaths.p24d6df00} fill="url(#paint1_linear_4332_6967)" fillRule="evenodd" id="vector_2" />
                            ...
                            <defs>
                              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4332_6967" x1="8.15606" x2="24" y1="7.22946" y2="23.0734">
                                <stop stopColor="#77ED8B" />
                                <stop offset="1" stopColor="#22C55E" />
                              </linearGradient>
                              <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_4332_6967" x1="0" x2="19.3023" y1="0" y2="19.3023">
