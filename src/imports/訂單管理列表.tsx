import svgPaths from "./svg-iaoxxcic0a";
...
function Tab() {
  return (
    <div className="content-stretch flex gap-[8px] h-[48px] items-center justify-center min-h-[48px] min-w-[48px] relative shrink-0" data-name="▼ Tab 1">
      ...
      <p className="css-ew64yg font-['Public_Sans:Medium',sans-serif] font-medium leading-[22px] relative shrink-0 text-[#1c252e] text-[14px]">All</p>
    </div>
  );
}
...
function EndIcon() {
  return (
    <div className="bg-[rgba(145,158,171,0.16)] content-stretch flex gap-[6px] h-[24px] items-center justify-center min-w-[24px] px-[6px] py-0 relative rounded-[6px] shrink-0" data-name="✳️ end icon">
      <p className="css-ew64yg font-['Public_Sans:Bold',sans-serif] font-bold leading-[20px] relative shrink-0 text-[#637381] text-[12px] text-center">32</p>
    </div>
  );
}
...
function Tab1() {
  return (
    <div className="content-stretch flex gap-[8px] h-[48px] items-center justify-center min-h-[48px] min-w-[48px] relative shrink-0" data-name="▼ Tab 2">
      <p className="css-ew64yg font-['Public_Sans:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[22px] relative shrink-0 text-[#637381] text-[14px]">未處理(NP)</p>
      <EndIcon />
    </div>
  );
}
...
function Button4() {
  return (
    <div className="bg-[#005eb8] content-stretch flex h-[36px] items-center justify-center px-[5px] py-0 relative rounded-[8px] shrink-0 w-[40px]" data-name="Button">
      <StartIcon3 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="start icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="start icon">
          <g id="primary-shape">
            <path d={svgPaths.p301b600} fill="var(--fill-0, white)" />
            <path d={svgPaths.pdef5300} fill="var(--fill-0, white)" />
            <path d={svgPaths.p197a4c00} fill="var(--fill-0, white)" />
          </g>
        </g>
      </svg>
    </div>
...
function Button5() {
  return (
    <div className="bg-[#ff5630] content-stretch flex h-[36px] items-center justify-center px-[5px] py-0 relative rounded-br-[8px] rounded-tr-[8px] shrink-0 w-[40px]" data-name="Button">
      <StartIcon4 />
    </div>
  );
}
...
function IconsSolidIcEvaMoreVerticalFill() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="icons/solid/ic-eva:more-vertical-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="icons/solid/ic-eva:more-vertical-fill">
          <g id="primary-shape">
            <path d={svgPaths.p25499600} fill="var(--fill-0, #637381)" />
            <path d={svgPaths.p10879e80} fill="var(--fill-0, #637381)" />
            <path d={svgPaths.p2d8b3280} fill="var(--fill-0, #637381)" />
          </g>
        </g>
      </svg>
    </div>
...
function SecondaryAction1() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[500px] shrink-0 size-[36px]" data-name="✳️ secondary action">
      <IconsSolidIcEvaMoreVerticalFill />
    </div>
  );
}
...
function TableCell20() {
  return (
    <div className="content-stretch flex items-center justify-end p-[16px] relative shrink-0 w-[68px]" data-name="Table/Cell">
      <SecondaryAction1 />
    </div>
  );
}
...
function Texts10() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-0 relative shrink-0" data-name="texts">
      <p className="css-ew64yg font-['Public_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#1c252e] text-[14px]">400649724</p>
    </div>
  );
}
...
function SecondaryAction2() {
  return (
    <div className="bg-[rgba(142,51,255,0.16)] content-stretch flex gap-[6px] h-[24px] items-center justify-center min-w-[24px] px-[6px] py-0 relative rounded-[6px] shrink-0" data-name="✳️ secondary action">
      <p className="css-ew64yg font-['Public_Sans:Bold',sans-serif] font-bold leading-[20px] relative shrink-0 text-[#5119b7] text-[12px] text-center">B</p>
    </div>
  );
}
...
function IconsSolidIcEvaMoreVerticalFill1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="icons/solid/ic-eva:more-vertical-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="icons/solid/ic-eva:more-vertical-fill">
...
function SecondaryAction3() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[500px] shrink-0 size-[36px]" data-name="✳️ secondary action">
      <IconsSolidIcEvaMoreVerticalFill1 />
    </div>
  );
}
...
function Texts18() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-0 relative shrink-0" data-name="texts">
      <p className="css-ew64yg font-['Public_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#1c252e] text-[14px]">400649725</p>
    </div>
  );
}
...
function IconsSolidIcEvaMoreVerticalFill2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="icons/solid/ic-eva:more-vertical-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="icons/solid/ic-eva:more-vertical-fill">
...
function SecondaryAction5() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[500px] shrink-0 size-[36px]" data-name="✳️ secondary action">
      <IconsSolidIcEvaMoreVerticalFill2 />
    </div>
  );
}
