import svgPaths from "./svg-2gq4xnil6q";
  ...
  return (
    <div className="absolute inset-[0.17%_0_3.69%_0]" data-name="stack">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.0001 34.6104">
        <g id="stack">
          <path clipRule="evenodd" d={svgPaths.p394a5c00} fill="url(#paint0_linear_87_21242)" fillRule="evenodd" id="vector" />
          <path clipRule="evenodd" d={svgPaths.p24400500} fill="url(#paint1_linear_87_21242)" fillRule="evenodd" id="vector_2" />
