...
const DraggableColumnHeader = ({ 
  ...
  column: Column; 
  index: number; 
  moveColumn: (dragKey: ContactColumnKey, hoverKey: ContactColumnKey) => void;
  updateColumnWidth: (key: ContactColumnKey, width: number) => void;
  autoFitWidth: (key: any) => void;
  sortConfig: { key: ContactColumnKey | null; direction: 'asc' | 'desc' | null };
  ...
  const [, drop] = useDrop({
    accept: 'column',
    hover: (item: { columnKey: ContactColumnKey; index: number }) => {
      if (item.index !== index) {
