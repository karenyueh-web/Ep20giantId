...
export const orderMockData: OrderRow[] = [
  ...
  {
    id: 24, status: 'CK', vendorDeliveryDate: '2025/04/18',
    orderNo: '400650109', orderDate: '2025/03/10', orderType: 'Z2HB',
    company: '巨大機械', purchaseOrg: '台灣廠生產採購組織', orderSeq: '90', docSeqNo: '400650109090',
    purchaser: '黃淑芬', orderQty: 250, acceptQty: 250, comparePrice: '2200', unit: 'PCS', currency: 'TWD',
    leadtime: 7, vendorCode: '00010059', vendorName: '金盛元工業(00010059)',
    materialNo: '1101-BRK0109-N09', customerBrand: 'G04', vendorMaterialNo: 'BR-R9270-DA-DISC-F',
    productName: '碟煞卡鉗', specification: 'SHIMANO BR-R9270 DURA-ACE DISC BRAKE CALIPER FRONT',
    expectedDelivery: '2026/03/02', deliveryQty: 250,
    inTransitQty: 0, undeliveredQty: 0, lineItemNote: '550000', agreedDate: '2025/04/17',
    internalNote: '', materialPOContent: '',
    gbdOrderNo: 'GBD-2025-002109', statisticalDeliveryDate: '2025/04/18',
  },
  {
    id: 25, status: 'CL', vendorDeliveryDate: '2025/02/28',
    orderNo: '400650110', orderDate: '2025/01/20', orderType: 'Z2HB',
    company: '巨大機械', purchaseOrg: '台灣廠生產採購組織', orderSeq: '100', docSeqNo: '400650110100',
    purchaser: '王大明', orderQty: 300, acceptQty: 300, comparePrice: '1450', unit: 'PCS', currency: 'TWD',
    leadtime: 10, vendorCode: '00010012', vendorName: '台灣製造(00010012)',
    materialNo: '1201-SPT0110-N10', customerBrand: 'G01', vendorMaterialNo: 'D-FUSE-SP-316X350',
    productName: '一體式座管', specification: 'D-FUSE SP COMPOSITE SEATPOST 31.6X350 INTEGRATED',
    expectedDelivery: '2026/03/02', deliveryQty: 300,
    inTransitQty: 0, undeliveredQty: 0, lineItemNote: '435000', agreedDate: '2025/02/27',
    internalNote: '', materialPOContent: '',
    gbdOrderNo: 'GBD-2025-002110', statisticalDeliveryDate: '2025/02/28',
  },
  {
    id: 26, status: 'CL', vendorDeliveryDate: '2025/03/05',
    orderNo: '400650111', orderDate: '2025/01/25', orderType: 'Z2HB',
    company: '巨大機械', purchaseOrg: '台灣廠生產採購組織', orderSeq: '110', docSeqNo: '400650111110',
    purchaser: '李玉霞', orderQty: 180, acceptQty: 180, comparePrice: '3800', unit: 'PCS', currency: 'USD',
    leadtime: 14, vendorCode: '00010045', vendorName: '精密��業(00010045)',
    materialNo: '1301-STM0111-N11', customerBrand: 'G05', vendorMaterialNo: 'CONT-SL-OD2-AERO-100',
    productName: '碳纖維龍頭', specification: 'CONTACT SL OD2 AERO STEM 100MM -6DEG CARBON',
    expectedDelivery: '2026/03/02', deliveryQty: 180,
...
const DraggableColumnHeader = ({
  ...
  column: OrderColumn;
  index: number;
  moveColumn: (dragKey: OrderColumnKey, hoverKey: OrderColumnKey) => void;
  updateColumnWidth: (key: OrderColumnKey, width: number) => void;
  ...
  const [, drop] = useDrop({
    accept: 'order-column',
    hover: (item: { columnKey: OrderColumnKey; index: number }) => {
      if (item.index !== index) {
