// sync-design-system.mjs — 同步最終 DESIGN_SYSTEM.md 至 Stitch
...
6 boxes: [6px Badge] [8px Button★] [10px Dropdown] [12px Card] [16px Page] [●500px Avatar]

══════ SECTION 5: BUTTON SYSTEM ══════
All 6 button variants in a row:
A) Primary: bg #1D7BF5 white text "應用"
B) Secondary: text #637381 "取消"
C) Toolbar: icon+text #1c252e "Columns"
D) ToolbarAction: text-only #004680 "檢視"
E) Danger: 36px red hover ✕
F) Ghost: dashed border "+ 新增條件"

══════ SECTION 6: INPUT PATTERNS ══════
3 inputs stacked:
- Standard h-36 border rounded-8 "搜尋廠商..."
- Floating label h-54 "狀態 ▾" with label "訂單狀態" at top-left edge
- react-select h-40 clearable "選擇廠商... ×"
...
Header row (56px bg #f4f6f8): [☑ 88px sticky] [單號序號 160px sticky] [訂單日期] [廠商名稱] [狀態]
Row 1 (76px, selected #rgba(0,94,184,0.04)): [☑] [400649723010 ← #1677ff underline] [2025/04/10] [速聯國際] [CP badge]
Row 2 (76px): [☐] [400649724020] [2025/04/11] [久廣精密] [V badge]
Footer: SelectionToolbar h-48 bg #d9e8f5: [☑] "1 selected" | "檢視" "提交"
